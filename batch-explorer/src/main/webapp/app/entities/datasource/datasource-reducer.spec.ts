...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POINT_LIST actions', async () => {
    ...
    it('dispatches FETCH_POINT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_POINT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_POINT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_POINT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_POINT actions', async () => {
      const expectedActions = [
        {
