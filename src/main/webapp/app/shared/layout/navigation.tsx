...
const NavLink = ({to, children, icon}: any) => {
  ...
  return (
      <li className="me-2" role="presentation">
        <button className={`p-4 border-b-2 rounded-t-lg flex focus:ring-0 hover:cursor-pointer
                ${isActive ? 'text-indigo-500' : 'text-gray-700 hover:bg-indigo-100 hover:text-indigo-500'}`}
                tabIndex={-1}
